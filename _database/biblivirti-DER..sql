...
START TRANSACTION;
USE `biblivirti`;
INSERT INTO `biblivirti`.`areainteresse` (`ainid`, `aicdesc`, `aidcadt`, `aidaldt`) VALUES (1, 'Computação/Informatíca', DEFAULT, DEFAULT);
INSERT INTO `biblivirti`.`areainteresse` (`ainid`, `aicdesc`, `aidcadt`, `aidaldt`) VALUES (2, 'Engenharia', DEFAULT, DEFAULT);
INSERT INTO `biblivirti`.`areainteresse` (`ainid`, `aicdesc`, `aidcadt`, `aidaldt`) VALUES (3, 'Medicina', DEFAULT, DEFAULT);
INSERT INTO `biblivirti`.`areainteresse` (`ainid`, `aicdesc`, `aidcadt`, `aidaldt`) VALUES (4, 'Matemática', DEFAULT, DEFAULT);
INSERT INTO `biblivirti`.`areainteresse` (`ainid`, `aicdesc`, `aidcadt`, `aidaldt`) VALUES (5, 'Educação', DEFAULT, DEFAULT);
INSERT INTO `biblivirti`.`areainteresse` (`ainid`, `aicdesc`, `aidcadt`, `aidaldt`) VALUES (6, 'Academia', DEFAULT, DEFAULT);
INSERT INTO `biblivirti`.`areainteresse` (`ainid`, `aicdesc`, `aidcadt`, `aidaldt`) VALUES (7, 'Agricultura', DEFAULT, DEFAULT);
INSERT INTO `biblivirti`.`areainteresse` (`ainid`, `aicdesc`, `aidcadt`, `aidaldt`) VALUES (8, 'Português', DEFAULT, DEFAULT);
INSERT INTO `biblivirti`.`areainteresse` (`ainid`, `aicdesc`, `aidcadt`, `aidaldt`) VALUES (9, 'Geografia', DEFAULT, DEFAULT);
INSERT INTO `biblivirti`.`areainteresse` (`ainid`, `aicdesc`, `aidcadt`, `aidaldt`) VALUES (10, 'Direito', DEFAULT, DEFAULT);
INSERT INTO `biblivirti`.`areainteresse` (`ainid`, `aicdesc`, `aidcadt`, `aidaldt`) VALUES (11, 'Contabilidade', DEFAULT, DEFAULT);
INSERT INTO `biblivirti`.`areainteresse` (`ainid`, `aicdesc`, `aidcadt`, `aidaldt`) VALUES (12, 'Economia', DEFAULT, DEFAULT);
INSERT INTO `biblivirti`.`areainteresse` (`ainid`, `aicdesc`, `aidcadt`, `aidaldt`) VALUES (13, DEFAULT, DEFAULT, DEFAULT);
...
INSERT INTO `biblivirti`.`usuario` (`usnid`, `uscfbid`, `uscnome`, `uscmail`, `usclogn`, `uscsenh`, `uscfoto`, `uscstat`, `usdcadt`, `usdaldt`) VALUES (3, NULL, 'Luiz Mario Ferreira', 'luizmario32@hotmail.com', 'luizmariodev', 'b0a34919896a856d85ec1fd1bf4ed3c4', NULL, 'A', DEFAULT, DEFAULT);
INSERT INTO `biblivirti`.`usuario` (`usnid`, `uscfbid`, `uscnome`, `uscmail`, `usclogn`, `uscsenh`, `uscfoto`, `uscstat`, `usdcadt`, `usdaldt`) VALUES (4, NULL, 'Cynara Carvalho Lira', 'cynaracarvalho@yahoo.com.br', 'cynaracarvalho', '6f15f21a7457ca703b70f7ad196e3418', '', 'A', DEFAULT, DEFAULT);
INSERT INTO `biblivirti`.`usuario` (`usnid`, `uscfbid`, `uscnome`, `uscmail`, `usclogn`, `uscsenh`, `uscfoto`, `uscstat`, `usdcadt`, `usdaldt`) VALUES (1, NULL, 'Suporte Biblivirti', 'suporte.biblivirti@gmail.com', 'suportebiblivirti', 'f64c61c5025df0e11b448825282e5d72', NULL, 'A', DEFAULT, DEFAULT);
...
START TRANSACTION;
USE `biblivirti`;
INSERT INTO `biblivirti`.`grupo` (`grnid`, `grnidai`, `grcnome`, `grcfoto`, `grctipo`, `grcstat`, `grdcadt`, `grdaldt`) VALUES (1, 1, 'Sysmob, Inc', NULL, 'F', 'A', DEFAULT, DEFAULT);
...
START TRANSACTION;
USE `biblivirti`;
INSERT INTO `biblivirti`.`grupousuario` (`gunidgr`, `gunidus`, `guladm`, `gucstat`, `gudcadt`, `gudaldt`) VALUES (1, 1, DEFAULT, 'A', DEFAULT, DEFAULT);
INSERT INTO `biblivirti`.`grupousuario` (`gunidgr`, `gunidus`, `guladm`, `gucstat`, `gudcadt`, `gudaldt`) VALUES (1, 2, DEFAULT, 'A', DEFAULT, DEFAULT);
INSERT INTO `biblivirti`.`grupousuario` (`gunidgr`, `gunidus`, `guladm`, `gucstat`, `gudcadt`, `gudaldt`) VALUES (1, 3, DEFAULT, 'A', DEFAULT, DEFAULT);
INSERT INTO `biblivirti`.`grupousuario` (`gunidgr`, `gunidus`, `guladm`, `gucstat`, `gudcadt`, `gudaldt`) VALUES (1, 4, 1, 'A', DEFAULT, DEFAULT);
