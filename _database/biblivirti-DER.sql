...
INSERT INTO `biblivirti`.`usuario` (`usnid`, `uscfbid`, `uscnome`, `uscmail`, `usclogn`, `uscsenh`, `uscfoto`, `uscstat`, `usdcadt`, `usdaldt`) VALUES (5, NULL, 'Vania Lasalvia', 'vania.lasalvia@gmail.com', 'vanialasalvia', 'd6d06ce5e334f03e18a6945a55674d51', NULL, 'A', DEFAULT, DEFAULT);
INSERT INTO `biblivirti`.`usuario` (`usnid`, `uscfbid`, `uscnome`, `uscmail`, `usclogn`, `uscsenh`, `uscfoto`, `uscstat`, `usdcadt`, `usdaldt`) VALUES (6, NULL, 'Alynne Raquel', 'alynneraquel@hotmail.com', 'alynneraquel', '82b03863ae235f0c8dbfc8632a20312f', NULL, 'A', DEFAULT, DEFAULT);
INSERT INTO `biblivirti`.`usuario` (`usnid`, `uscfbid`, `uscnome`, `uscmail`, `usclogn`, `uscsenh`, `uscfoto`, `uscstat`, `usdcadt`, `usdaldt`) VALUES (7, NULL, 'Aurélio Souza', 'aureliosm@gmail.com', 'aureliosm', 'bd44670340339bc8edbd3343797628a5', NULL, 'A', DEFAULT, DEFAULT);
INSERT INTO `biblivirti`.`usuario` (`usnid`, `uscfbid`, `uscnome`, `uscmail`, `usclogn`, `uscsenh`, `uscfoto`, `uscstat`, `usdcadt`, `usdaldt`) VALUES (8, NULL, 'Caíque Rodrigues', 'caiqueadesouza@gmail.com', 'caiqueadesouza', '7f35e980c27c35ce1700928d96b216dd', NULL, 'A', DEFAULT, DEFAULT);
INSERT INTO `biblivirti`.`usuario` (`usnid`, `uscfbid`, `uscnome`, `uscmail`, `usclogn`, `uscsenh`, `uscfoto`, `uscstat`, `usdcadt`, `usdaldt`) VALUES (9, NULL, 'Carlos Alberto Batista', 'carlos36_batista@hotmail.com', 'carlosbatistateixeira', 'f92b045a3e8c69574f01606e69d89414', NULL, 'A', DEFAULT, DEFAULT);
INSERT INTO `biblivirti`.`usuario` (`usnid`, `uscfbid`, `uscnome`, `uscmail`, `usclogn`, `uscsenh`, `uscfoto`, `uscstat`, `usdcadt`, `usdaldt`) VALUES (10, NULL, 'Cláudio Henrique', 'claudiiinho@gmail.com', 'claudiohenrique', 'aecb9f303cbf7b3b03f3f242f2c2f02d', NULL, 'A', DEFAULT, DEFAULT);
...
INSERT INTO `biblivirti`.`grupousuario` (`gunidgr`, `gunidus`, `guladm`, `gucstat`, `gudcadt`, `gudaldt`) VALUES (1, 7, 0, 'A', DEFAULT, DEFAULT);
INSERT INTO `biblivirti`.`grupousuario` (`gunidgr`, `gunidus`, `guladm`, `gucstat`, `gudcadt`, `gudaldt`) VALUES (1, 8, 0, 'A', DEFAULT, DEFAULT);
INSERT INTO `biblivirti`.`grupousuario` (`gunidgr`, `gunidus`, `guladm`, `gucstat`, `gudcadt`, `gudaldt`) VALUES (1, 9, 0, 'A', DEFAULT, DEFAULT);
