...
CREATE TABLE IF NOT EXISTS `biblivirti`.`resposta` (
  ...
  `redindt` TIMESTAMP NOT NULL,
  `redendt` TIMESTAMP NULL,
  PRIMARY KEY (`renid`),
  CONSTRAINT `FKREAL`
    FOREIGN KEY (`renidal`)
...
START TRANSACTION;
USE `biblivirti`;
INSERT INTO `biblivirti`.`grupo` (`grnid`, `grnidai`, `grcnome`, `grcfoto`, `grctipo`, `grcstat`, `grdcadt`, `grdaldt`) VALUES (1, 1, 'Sysmob, Inc', NULL, 'F', DEFAULT, DEFAULT, DEFAULT);
