...
<head>
    ...
    <meta name="description" content="Biblivirti - Ambiente Virtual de Aprendizagem Móvel (AVAM).">
    ...
    <!-- JQuery Javascript -->
    <script href="<?php echo base_url(ASSETS_JS_PATH . 'jquery.min.js'); ?>"></script>
    <!-- Bootstrap Javascript -->
    <script href="<?php echo base_url(ASSETS_JS_PATH . 'bootstrap.min.js'); ?>"></script>
